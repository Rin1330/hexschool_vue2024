export default {
  props:['tempProduct', 'updateProduct', 'isNew', 'createSubImages'],
              ...
              <div v-if="Array.isArray(tempProduct.imagesUrl)">
                <div class="mb-1" v-for="(image, key) in tempProduct.imagesUrl" :key="key">
                  <div class="mb-3">
                    ...
                    <input type="text" :id="key+123" v-model="tempProduct.imagesUrl[key]" class="form-control" placeholder="請輸入圖片連結">
                  </div>
